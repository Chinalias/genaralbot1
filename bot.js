...
client.on('ebnklb',function(ebnklb) {
    ...
    if(ebnklb.content.startsWith(`<@${client.user.id}>`)) {
        ebnklb.channel.send('Hey Im **You server bot !**  A Nice Bot Developed By:`Baktash`')
...
**
        ***__General orders__***
**
『Ballbots/لعرض جميع البوتات الي بالسيرفر』
『Bserver/يعرض لك معلومات عن السيرفر』
『Bbot/يعرض لك كل معلومات البوت』
『Bskin <name>/يعرض لك سكنك بماين كرافت』
『Bcount/يعرض لك عدد الاشخاص بالسيرفر بدون بوتات』
『Binvites/ يعرض لك  عدد انفايتاتك بالسيرفر 』
『Btrans <language> <any thing>/يترجم لك الي تبيه من اي لغة』
『Bshort/يختصر لك رابط كبير الى رابط صغير』
『Btag/يكتب لك الكلمة بشكل جميل وكبير』
『Bgoogle/للبحث في قوقل عن طريق الدسكورد』
『Bperms/يعرض لك برمشناتك بالسيرفر』
『Byn/تسأل بوت والبوت يجاوبك بنعم او لا』
『Bw/امر يخليك مثل بوت تكتب عبره مع امر ويسويك بوت』
『Bza5/يزخرف لك كلمة او جملة』
『Brooms/يعرض لك كل الرومات الي بالسيرفر مع عددها』
『Broles/يعرض لك كل الرانكات بالسيرفر بشكل جميل』
『Bemojilist/يعرض لك كل الايموجيات الي بالسيرفر』
『Bsay/يكرر الكلام الي تكتبو』
『Bimage/صورة السيرفر』
『Bmembers/��عرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص』
『Bid/معلومات عنك』
『Bprofile/عرض بروفايل حقك』
『Btc/انشاء روم مؤقت ويمكنك تحديد الاعدادات』
『Bbans / عدد الاشخاص المبندة 』
『Bvoice /  يوم لك بكتابه مجموع عدد الاشخاص الموجودين برومات』
『Bavatar/صورتك او صورة الي تمنشنو』
『Bembed/يكرر الي تقولو بشكل حلو』
『Bdiscrim/كود يضهر لك الاشخاص نفس تاقك』
『Bemoji <any things>/لتحويل اي كلمه تقولها الي ايموجي』
『Binv/لدعوة البوت الى سيرفرك』
『Bsupport/سيرفر الدعم』
『Bcontact/ارسال اقتراح او لمراسلة صاحب البوت』
**
  `
,`
        ***__Administrative Orders__***
**
『Bmove @user /  لسحب الشخص الى روومك』
『Bvoiceonline /  لتفعيل خاصيه فويس اونلاين يسحب عدد الاشخاص موجودين برومات』
『Bbc / رسالة جماعية الى كل اعضاء السيرفر』
『Bbcrole / لارسال رساله جماعي لرتبه محدده يجب تمنشنها 』
『Brole @user <rank> / لأعطاء رتبة لعضو معين』
『Broleremove @user <rank> / لازالة الرتبة من شخص معين』
『Brole all <rank> / لأعطاء رتبة للجميع』
『Brole humans <rank> / لأعطاء رتبة للاشخاص فقط』
『Brole bots <rank> / لأعطاء رتبة لجميع البوتات』
『Bhchannel / اخفاء الشات』
『Bschannel / اضهار الشات المخفية』
『Bclr <numbr> / مسح الشات بعدد』
『Bclear / مسح الشات』
『Bmute @user <reason> / اعطاء العضو ميوت لازم رتبة <Muted>』
『Bunmute @user / لفك الميوت عن الشخص 』
『Bkick @user <reason> / طرد الشخص من السيرفر』
『Bban @user <reason> / حضر الشخص من السيرفر』
『Bmutechannel / تقفيل الشات』
『Bunmutechannel / فتح الشات』
『Bdc / مسح كل الرومات』
『Bdr / <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات』
『Bct <name> / انشاء شات』
『Bcv <name> / انشاء رووم فويس』
『Bdelet <name> / مسح الشات او الرووم فويس』
『❖Bccolors <number> / ينشا لك الوان مع كم الوان تبي』
   `,`
        ***__Music orders__***
**
...
『Bلعبة فكك / فكك』
『Bعواصم عشوائي/عواصم』
『Bلعبة كت تويت / كت تويت』
『Broll <number> / قرعة』
『Bلو خيروك بطريقة حلوة / لو خيروك』
『Bلعبة مريم / مريم』
『Bفوائد ونصائح  / هل تعلم』
『Bيعطيك عقابات قاسية / عقاب 』
...
var v1 = new Discord.RichEmbed()
  ...
  v1.setFooter("# Baktash team. |")
var heroo = new Discord.RichEmbed()
.setColor('#6a109d')
.setTimestamp(new Date())
.setThumbnail(client.user.avatarURL)
.setTitle('Baktash team')
.setURL('https://discord.gg/cNDSrFg')
.setAuthor(client.user.username,client.user.avatarURL)
...
if (!points[message.author.id]) points[message.author.id] = {
  ...
  if(!message.guild) return;
    let id = message.author.id,prefix="B";
...
client.on("message", (message) => {
    if (message.content.startsWith('‏Bdelet')) {
        if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
...
const sWlc = {}
const premium = ['331081268731052042']
client.on('message', message => {
var prefix = "B";
  ...
  const channel = sWlc[member.guild.id].channel
    ...
    let memberavatar = member.user.avatarURL
     ...
     welcomer.send({embed:heroo});          
      ...
      const w = ['PicsArt_07-17-07.58.02_1.png'];
